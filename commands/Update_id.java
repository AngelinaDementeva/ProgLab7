...
public class Update_id
{
    ...
    public void update(final String orgId) throws InterruptedException {
        final int id = Integer.parseInt(orgId);
        final Organization newOrg = new Organization(id, this.makerName(), this.makerAnnualTurnover(), "0", this.makerFullName(), this.makerOrganizationType(), this.makerAddress(), this.makerCoordinates(), ClientTCP.myUserID);
